...
- **Campaign** — 12 linear stages (Jakarta offices → outdoor tank battle → depot/train journey and Bandung HQ → Pasupati/Cisumdawu → Kertajati airport → Stage 10 port/forest → IKN root transmitter/Warden → Monas/Mahapatih finale), an inter-stage shop through Stage 11, loot
