...
// ===== CHEAT: lompat LANGSUNG ke stage campaign n (2/3/4/5/6; 1 juga aman) —
...
export function campaignJumpToStage(n) {
    ...
    const target = [null, stage1Scene, stage2Scene, stage3Scene, stage4Scene, stage5Scene, stage6Scene][n];
