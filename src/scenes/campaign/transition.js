...
import { stage1Scene } from './stage1.js';   // restartScene (circular aman: dibaca DI DALAM fungsi)
import { stage2Scene, placeRobots as placeStage2Robots } from './stage2.js';   // (circular aman: DI DALAM fungsi)
