...
export const goStageStats = document.getElementById('goStageStats');
export const goTotalTime = document.getElementById('goTotalTime');
export const goLootBoxes = document.getElementById('goLootBoxes');
